...
%
%   1열  스로틀 D          [-1, 1].  D>0 구동, D<0 제동
%   2열  조향각 delta      제약 +-30 deg (점선)
%   3열  조향각속도        제어 주기로 나눈 값
%
...
fprintf(['\nSteering rate divides by the control period. Residual runs at 6.4-6.5 Hz ' ...
         '(pre solver fix)\nexcept the high-speed case, where both are 10 Hz.\n\n']);
